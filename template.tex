...
\shorttitle{How-To Thesis Formalities at VIS-IS}


%% Abstract section.
\abstract{%
  The document summarizes style guidelines for formal text documents such as theses and seminars in the Intelligent Systems Group, Institute for Visualization and Interactive Systems.
} % end of abstract
